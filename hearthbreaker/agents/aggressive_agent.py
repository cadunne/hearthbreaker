...
from hearthbreaker.agents.trade.aggressive import TradeMixin, AttackMixin
...
class AggressiveAgent(TradeMixin, AttackMixin, PlayMixin, ChooseTargetMixin, DoNothingAgent):
    def __init__(self):
        super().__init__()
