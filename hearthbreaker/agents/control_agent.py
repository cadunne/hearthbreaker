...
from hearthbreaker.agents.trade.control import TradeMixin, AttackMixin
...
class ControlAgent(TradeMixin, AttackMixin, PlayMixin, ChooseTargetMixin, DoNothingAgent):
    def __init__(self):
        super().__init__()
